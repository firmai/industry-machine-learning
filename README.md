...
#### To encourage active participation, I have created a [private repo](https://github.com/firmai/industry-ml-private) where all future edits and entries will be made starting November 2019. To join indefinitely you have to submit two unique open source python ML or DS projects (unique to this list only, it needen't be your own). Please submit them now so that I can add you to the list. If you happen to be part of the newsletter and really want to join without contributing just send me an email d.snow@firmai.org with your GitHub username. This project repository is not being disgarded; once every year I will update the public list with new projects from the private list. How to know if your contribution is unique: search the [Google Sheet](https://docs.google.com/spreadsheets/d/1pVdV3r4X3k5D1UtKbhMTmjU8mJTZSLAhJzycurgh_o4/edit?usp=sharing) file for the respective URL.
---
</br>
