...
#### To encourage active participation, I have created a private repo where all future edits and entries will be made starting November 2019 after which this project will be deprecated. To join indefinitely you have to submit two unique open source python ML or DS projects now to d.snow@firmai.org (unique to this list only, it needen't be your own). Please submit them now so that I can add you to the list. If you happen to be part of the newsletter and really want to join without contributing just send me an email with your GitHub username. How to know if your contribution is unique: search the [Google Sheet](https://docs.google.com/spreadsheets/d/1pVdV3r4X3k5D1UtKbhMTmjU8mJTZSLAhJzycurgh_o4/edit?usp=sharing) file for the respective URL.
---
</br>
