...
- You can definitely park on both these and the people links to see if there are more out there. 
- In a way its required that you put these in a table format, possibly online drive file, doing this would further facilitate collaboration, and it would help to show which have and have not yet been added to this list. People can also more easily make there contribution. Good idea. However, this should only happen after this last purge, and above and beyond that purge, you should get someone that convert that information back and absorb it into excel. Oka lets have a lok. - Freelancer can be used. Would love this sort of updating. 
    - Another way of doing this is the simple porting mechanism. - You just make sure yhou clean it ou in the way  that you would clean out your draft on Dropbox paper too. 

Analytics Vidiya Hackthons- https://github.com/SudalaiRajkumar/ML
More hacks- https://github.com/bhavsarpratik/hackathons
For Good - https://github.com/bbahov/hackathon-for-good/tree/master/RedCross_1/Solutions
[Self Regulation Ontology](https://github.com/zenkavi/Self_Regulation_Ontology) - Research program to develop an ontology of self-regulation. - Psychology regulation

[Urban Course](https://github.com/gboeing/urban-data-science) - Urban data science course
[OSMnx](https://github.com/gboeing/osmnx-examples) - Open street map for street networks. 
...
| Justice, Law and Regulations     | Accounting & Auditing            | Charities                         |
...
----------
- Different terminology mechanical engineering - https://github.com/m2n037/awesome-mecheng
- Also python robotics
## 
## Education & Research
...
— You have to get a new slant, normal medical exists.
**Epidemiology**

- Bio-informative Workshop - https://github.com/sbl-sdsc/mmtf-workshop-2018
